...
```env
BID_ACCESS_CODE=e1c0d498c7eb5e39f23d89edb422bc811d7fab3198ad6939
```
...
*Expected Output:*
```
✓ test/predator.test.ts (3 tests)
✓ test/risk.test.ts (49 tests)
✓ test/signals.test.ts (11 tests)
✓ test/decide.test.ts (56 tests)
